...
CREATE TABLE `answers` (
  ...
  `Scrumptious` varchar(45) DEFAULT NULL,
  `Ample` varchar(45) DEFAULT NULL,
  `Preposterous` varchar(100) DEFAULT NULL,
...
INSERT INTO `answers` VALUES (22,'Kosta','Vigulear','null','null','null','null','null','Minimal','','null',''),(35,'Andrei','Vigulear','Eternal','Something of small size, amount, or scope','Indescribable','Equivocal','Tasty','Abundant','Insane Absurd Bizarre ','Phone','To argue about something'),(48,'Natalia','Pahomova','Nice','It is a long story','Awful','Equivocal','Disgusting','Abundant',' Insane Hypocritical Bizarre','Cup of coffee','kgfk\r\nkhgkjg\r\nlkghkjhg');
...
-- Dump completed on 2020-12-13 23:52:46
